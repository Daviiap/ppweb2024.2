...
VALUES
    (
        ...
        'Davi Pontes',
        'davi.pontes@sapiens.com.br',
        '$argon2id$v=19$m=65536,t=3,p=4$u6pyjElkbk8+9msb6RS41g$H0LT9XIOyvEIdySdAPOAY/z+vaqJ2rqypFprZ6ZhTUE' -- senha123
    ),
    (
        '5057acbf-72c0-471b-9df0-d3bfc0f68788',
        'Jose Glauber',
        'jose.glauber@sapiens.com.br',
        '$argon2id$v=19$m=65536,t=3,p=4$u6pyjElkbk8+9msb6RS41g$H0LT9XIOyvEIdySdAPOAY/z+vaqJ2rqypFprZ6ZhTUE' -- senha123
    ),
    (
        '526a7008-f05d-4072-8c3b-6a1e4c20fef7',
        'Jade Castor',
        'jade.castor@sapiens.com.br',
        '$argon2id$v=19$m=65536,t=3,p=4$u6pyjElkbk8+9msb6RS41g$H0LT9XIOyvEIdySdAPOAY/z+vaqJ2rqypFprZ6ZhTUE' -- senha123
    );
